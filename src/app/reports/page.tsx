...
export default function ReportsPage() {
    ...
    const filteredOrders = completedOrders.filter(o => {
        ...
        return matchesWaiter && matchesMonth && matchesProduct && matchesDateRange;
    });
                    ...
                    >
                        <div className="glass-card p-10 rounded-[3rem] border-white/10 bg-white/5 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-white/5">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1">Starting Date</label>
                                    <input
                                        type="date"
                                        value={startDate}
                                        onChange={e => {
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest pl-1">Ending Date</label>
                                    <input
                                        type="date"
                                        value={endDate}
                                        onChange={e => {
